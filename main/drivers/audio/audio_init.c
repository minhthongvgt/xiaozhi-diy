...
#if 0
#error "This function should not be called with C++ AudioCodec layer"
esp_err_t audio_driver_init_speaker(void)
{
    ...
    bclk_pin = (gpio_num_t)CONFIG_CUSTOM_AUDIO_SPK_GPIO_BCLK;
#endif
#if defined(CONFIG_CUSTOM_AUDIO_SPK_GPIO_LRCK)
    lrck_pin = (gpio_num_t)CONFIG_CUSTOM_AUDIO_SPK_GPIO_LRCK;
#endif
#if defined(CONFIG_CUSTOM_AUDIO_SPK_GPIO_DOUT)
    dout_pin = (gpio_num_t)CONFIG_CUSTOM_AUDIO_SPK_GPIO_DOUT;
#endif
...
esp_err_t audio_driver_init_mic(void)
{
    ...
    sck_pin = (gpio_num_t)CONFIG_CUSTOM_AUDIO_MIC_GPIO_SCK;
#endif
#if defined(CONFIG_CUSTOM_AUDIO_MIC_GPIO_WS)
    ws_pin  = (gpio_num_t)CONFIG_CUSTOM_AUDIO_MIC_GPIO_WS;
#endif
#if defined(CONFIG_CUSTOM_AUDIO_MIC_GPIO_DIN)
    din_pin = (gpio_num_t)CONFIG_CUSTOM_AUDIO_MIC_GPIO_DIN;
#endif
