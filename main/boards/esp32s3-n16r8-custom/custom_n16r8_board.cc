...
private:
...
#endif
#if defined(CONFIG_CUSTOM_ENABLE_PERIPH_IR_REMOTE)
    ...
    void InitializeUnimplementedPeripherals() {
...
#endif
#if defined(CONFIG_CUSTOM_ENABLE_PERIPH_IR_REMOTE)
        ESP_LOGW(TAG, "IR driver hardware transmission is not yet implemented.");
#endif
#if defined(CONFIG_CUSTOM_ENABLE_SENSOR_INA2XX)
        ESP_LOGW(TAG, "INA2xx driver is not yet implemented.");
#endif
#if defined(CONFIG_CUSTOM_ENABLE_PERIPH_SDCARD_SPI)
...
#endif
#if defined(CONFIG_CUSTOM_ENABLE_SENSOR_DS18B20)
        ESP_LOGW(TAG, "DS18B20 Temperature sensor driver is not yet implemented.");
#endif
#if defined(CONFIG_CUSTOM_ENABLE_SENSOR_FLOW_PCNT)
...
#endif
#if defined(CONFIG_CUSTOM_ENABLE_PERIPH_RFID_RC522)
...
#endif
#if defined(CONFIG_CUSTOM_BATTERY_MONITOR_BQ27220)
        ...
        // Các ngoại vi & cảm biến ĐÃ được hỗ trợ đầy đủ bởi SensorManager & ActuatorManager:
