...
#elif defined(CONFIG_CUSTOM_DISPLAY_UART) || defined(CONFIG_ENABLE_CUSTOM_SECONDARY_UART_DISPLAY)
#define DISPLAY_UART_TX_PIN GPIO_NUM_17
#else
#define DISPLAY_UART_TX_PIN GPIO_NUM_NC
#endif
...
#else
#define DISPLAY_UART_RX_PIN GPIO_NUM_NC
#endif
...
#elif defined(CONFIG_ENABLE_CUSTOM_UART)
#define CUSTOM_UART_TX_PIN GPIO_NUM_17
#else
#define CUSTOM_UART_TX_PIN GPIO_NUM_NC
#endif
...
#else
#define CUSTOM_UART_RX_PIN GPIO_NUM_NC
#endif
...
#else
#define SERVO_PWM_PIN GPIO_NUM_NC
#endif
#else
#define SERVO_PWM_PIN GPIO_NUM_NC
#endif
