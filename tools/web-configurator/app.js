  ...
  static renderModalFields(category, type) {
    ...
    if (category === "buttons") {
      if (type === "rotary") {
        fieldsContainer.innerHTML = `
          <div class="form-item">
            ...
            <input type="number" class="form-control" id="modal_field_rot_a" min="0" max="48" value="17">
          </div>
          <div class="form-item">
            <label class="form-label" for="modal_field_rot_b">Phase B Pin</label>
            <input type="number" class="form-control" id="modal_field_rot_b" min="0" max="48" value="18">
          </div>
          <div class="form-item">
      ...
      if (type === "led") {
        ...
        fieldsContainer.innerHTML = `
          <div class="form-item"><label class="form-label">PWMA Pin</label><input type="number" class="form-control" id="modal_field_pwma" value="1"></div>
          <div class="form-item"><label class="form-label">DIRA Pin</label><input type="number" class="form-control" id="modal_field_dira" value="2"></div>
          <div class="form-item"><label class="form-label">PWMB Pin</label><input type="number" class="form-control" id="modal_field_pwmb" value="41"></div>
          <div class="form-item"><label class="form-label">DIRB Pin</label><input type="number" class="form-control" id="modal_field_dirb" value="42"></div>
        `;
      } else if (type === "sensor_vl6180x") {
        fieldsContainer.innerHTML = `
        ...
        fieldsContainer.innerHTML = `
          <div class="form-item">
            ...
            <select class="form-control" id="modal_field_adc">
              ...
              <option value="2">ADC1 Channel 2 (GPIO 3)</option>
  ...
  static saveItemFromModal() {
    ...
    if (currentModalCategory === "buttons") {
      ...
      if (type === "sensor_hcsr04") {
        ...
        configState.peripherals.push({ id, type, name: "Laser ToF VL6180X", sda, scl });
      } else if (type === "motor_dc") {
        ...
        const nameMap = {
          ...
          sensor_dht: "Cảm biến nhiệt độ DHT11/22",
          sensor_pir: "Cảm biến chuyển động PIR",
